# [CLASE 2] Tests actualizados para weather.py refactorizado con match/case.
# Los tests no cambian — el contrato de la función es idéntico.
# Esto demuestra que match/case es un refactor transparente para los tests.
...
"""Tests unitarios para pycommute.weather — Clase 2."""
