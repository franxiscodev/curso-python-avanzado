# [CLASE 2] Tests del nuevo módulo route.py — mismo patrón de mocking que weather.
# Verifican el contrato: campos del resultado y propagación de HTTPStatusError.
# [CLASE 4 →] Se añadirán fixtures parametrizadas para probar los 3 perfiles
# de transporte y casos edge (ruta imposible, coordenadas fuera de rango).
