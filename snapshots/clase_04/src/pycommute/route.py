# [CLASE 4] route.py sin cambios de codigo — igual que weather.py.
# La suite de tests añade 5 tests para get_route, incluyendo verificacion
# de conversion de unidades (m->km, s->min) y parametrize con 3 perfiles.
# [CLASE 5 ->] get_route se convertira en async con httpx.AsyncClient.
