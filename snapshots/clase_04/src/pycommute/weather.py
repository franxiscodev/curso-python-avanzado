# [CLASE 4] weather.py sin cambios de codigo — el entregable de Clase 4 son los tests.
# El codigo se estabilizo en Clase 3 con loguru + @retry + pydantic-settings.
# Clase 4 añade cobertura de tests sin modificar la logica de negocio.
# [CLASE 5 ->] get_current_weather se convertira en async con httpx.AsyncClient.
