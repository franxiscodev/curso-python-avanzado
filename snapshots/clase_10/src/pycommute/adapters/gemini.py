...
# [CLASE 10] Archivo nuevo. Implementa AIPort via duck typing.
# Antes (Clase 9): el sistema solo tenia clima y rutas — sin interpretacion.
# Ahora: GeminiAdapter traduce datos estructurados en lenguaje natural.
# El pipeline: WeatherData + RouteData → prompt → JSON → AIRecommendation.
# [CLASE 11 →] OllamaAdapter implementara el mismo AIPort para uso offline.
# CommuteService usara el patron fallback: Gemini primero, Ollama si falla.
