...
Nota pedagógica: versión Clase 3 — sin cambios respecto a Clase 2.
"""

# [CLASE 3] route.py no recibe loguru ni @retry esta clase intencionalmente.
# Un concepto bien aplicado en un lugar (weather.py) vale más que dos
# aplicaciones apresuradas. El alumno puede aplicarlo como ejercicio opcional.
# [CLASE 4 →] Los tests de route.py se usan para demostrar el contraste
# before/after — el módulo sin @retry es el punto de partida.
