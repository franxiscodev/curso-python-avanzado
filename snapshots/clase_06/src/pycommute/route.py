...
# [CLASE 6] Sin cambios en este archivo — route.py se mantiene igual que Clase 5.
# Las rutas se acceden ahora vía iter_routes() en commute.py (AsyncGenerator).
# [CLASE 8 →] route.py se convierte en adaptador que implementa RoutePort.
