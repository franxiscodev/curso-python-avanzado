...
# [CLASE 6] Sin cambios en este archivo — weather.py se mantiene igual que Clase 5.
# El foco de Clase 6 es cache.py (lru_cache) y commute.py (generador + profiling).
# [CLASE 8 →] weather.py se convierte en adaptador que implementa WeatherPort.
