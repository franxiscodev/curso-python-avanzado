...
# Pista: repasa la sección 2 (match/case básico — literales, OR y wildcard) en 01_conceptos.md
...
# Pista: repasa la sección 3 (Patrones de mapping y secuencia) en 01_conceptos.md
...
# Pista: repasa la sección 3 (Patrones de mapping y secuencia) — el operador *resto en 01_conceptos.md
...
# Pista: repasa la sección 1 (¿Qué es Structural Pattern Matching?) — patrones de clase en 01_conceptos.md
